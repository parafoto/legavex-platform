# LegasVex Advisor Portal

<p align="center">
  <strong>Кабинет консультанта для legal-tech платформы LegasVex</strong>
</p>
...
LegasVex Advisor Portal — веб-платформа для управления юридическими консультациями. Система позволяет консультантам принимать дела, вести переписку с клиентами, загружать документы, а администраторам — контролировать качество и управлять процессами.
...
git clone https://github.com/parafoto/legasvex-platform.git
cd legasvex-platform
...
```env
# Database
DATABASE_URL=postgresql://user:password@localhost:5432/legasvex_platform
...
LegasVex Advisor Portal работает совместно с Telegram ботом:
